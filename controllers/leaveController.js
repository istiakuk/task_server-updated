...
exports.applyLeave = async (req, res) => {
  try {
    ...
    const { department, leaveType, startingDate, finishingDate } = req.body;
    
    // Create leave application for the authenticated user
    const newLeave = await Leave.create({ userId, department, leaveType, startingDate, finishingDate });
